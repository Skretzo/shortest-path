...
public class PathfinderProfile
{
	...
	public long getAddNeighborsNanos()
	{
		return addNeighborsNanos;
	}
	public long getQueueSelectionNanos()
	{
		return queueSelectionNanos;
	}
	public long getTargetCheckNanos()
	{
		return targetCheckNanos;
	}
	public long getWildernessCheckNanos()
	{
		return wildernessCheckNanos;
	}
	public long getCutoffCheckNanos()
	{
		return cutoffCheckNanos;
	}
	public long getBookkeepingNanos()
	{
		return bookkeepingNanos;
	}
	public long getBankCheckNanos()
	{
		return bankCheckNanos;
	}
	public long getTransportLookupNanos()
	{
		return transportLookupNanos;
	}
	public long getCollisionCheckNanos()
	{
		return collisionCheckNanos;
	}
	public long getWalkableTileNanos()
	{
		return walkableTileNanos;
	}
	public long getBlockedTileTransportNanos()
	{
		return blockedTileTransportNanos;
	}
	public long getAbstractNodeNanos()
	{
		return abstractNodeNanos;
	}
	public int getTileNeighborsAdded()
	{
		return tileNeighborsAdded;
	}
	public int getTransportNeighborsAdded()
	{
		return transportNeighborsAdded;
	}
	public int getVisitedSkipped()
	{
		return visitedSkipped;
	}
	public int getAbstractNodesExpanded()
	{
		return abstractNodesExpanded;
	}
	public int getTransportEvaluations()
	{
		return transportEvaluations;
	}
	public int getBlockedTileTransportChecks()
	{
		return blockedTileTransportChecks;
	}
	public int getBankTransitions()
	{
		return bankTransitions;
	}
	public int getWildernessLevelChanges()
	{
		return wildernessLevelChanges;
	}
	public int getDelayedVisitEnqueued()
	{
		return delayedVisitEnqueued;

	}
	public int getDelayedVisitSkipped()
	{
		return delayedVisitSkipped;

	}
	public int getPeakBoundarySize()
	{
		return peakBoundarySize;
	}
	public int getPeakPendingSize()
	{
		return peakPendingSize;
	}
	public List<ProfileSample> getSamples()
	{
		return samples;
	}
	public Map<Integer, int[]> getTileVisitCounts()
	{
		return tileVisitCounts;
	}
