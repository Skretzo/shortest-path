...
public final class DashboardScenario
{
	...
	public List<ItemQuantity> getInventory()
	{
		return inventory;
	}

	public List<ItemQuantity> getEquipment()
	{
		return equipment;
	}

	public List<ItemQuantity> getBank()
	{
		return bank;
	}
	...
	public Map<Integer, Integer> getVarplayers()
	{
		return varplayers;
	}
	...
	public OptionalInt getExpectedLength()
	{
		return expectedLength;
	}

	public OptionalInt getMinimumLength()
	{
	...
	public static final class Builder
	{
		...
		public Builder endPoint(int endPoint)
		{
		...
		{
			this.preset = preset != null ? preset.toUpperCase() : "NONE";
			return this;
		}

		public Builder inventory(List<ItemQuantity> inventory)
		{
			this.inventory = inventory;
			return this;
		}

		public Builder equipment(List<ItemQuantity> equipment)
		{
			this.equipment = equipment;
			return this;
		}

		public Builder bank(List<ItemQuantity> bank)
		{
			this.bank = bank;
			return this;
		}

		public Builder varbits(Map<Integer, Integer> varbits)
		{
			this.varbits = varbits;
			return this;
		}

		public Builder varplayers(Map<Integer, Integer> varplayers)
		{
		...
		public Builder expectedLength(int len)
		{
			this.expectedLength = OptionalInt.of(len);
			return this;
		}

		public Builder minimumLength(int len)
		{
			this.minimumLength = OptionalInt.of(len);
			return this;
		}
